...
So, its no secret that my wife and I are fans of Rhett and Link's YouTube series
Good Mythical Morning. Specifically, we are fans of the large variety of food-
related content like [Will it Burger?](https://www.youtube.com/watch?v=Mc4t66r54dU), [Worst Halloween Candy Taste Test](https://www.youtube.com/watch?v=xOO6Rk9XLE8), [International Burger King Taste Test](https://www.youtube.com/watch?v=vbAzAIvifkg&list=PLJ49NV73ttrvzyYLLkhoyqe51ptzxCROA),
and [100 Years of Party Snacks Taste Test](https://www.youtube.com/watch?v=qHwpBQAx9KA&list=PLJ49NV73ttrsJeC5lFgHADqyxWXB38yfd&index=40). 
...
Now, another strategy might be randomly guess, but not repeat any previous guesses. Instead of the guesses being independent, they are now dependent on prior guesses. That means we need to use a different method to
calculate this. The hypergeometric distribution is commonly used to calculate this (e.g. `dhyper()`). This also falls within the realm of permutation-based math ala [derangements](https://math.stackexchange.com/questions/2195572/how-do-i-find-the-probability-of-one-correct-guess-when-matching-elements). However, I am a simple man with a good computer and a less-good maths background, so I will simply simulate it.
