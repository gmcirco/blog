...
I would also caution against extrapolation. The data here comes for 30 orders
from a single city in the US. It is a limited set of data with a limited number
of observations. So, as always with science, some degree of skepticism is always
warranted.
